...
if matches[1] == 'تعطيل' and matches[2] and string.match(matches[2], '^%d+$') then
    local data = load_data(_config.moderation.data)
			...
			save_data(_config.moderation.data, data)
	   send_msg(matches[2], "🔲┇ تم تعطيل البوت من قبل المطور للاستفسار راسل @CHTH3CZAR", nil, 'md')
...
🔲┇ ـ➖➖➖➖➖
🔲┇ راسلني للاستفسار 💡↭  [TH3HELL](Telegram.Me/CHTH3CZAR) ]]
...
{
{text= ' CH - TH3HELL ' ,url = 'https://t.me/CHTH3CZAR'}
}					
}
