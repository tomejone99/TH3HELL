...
send_msg(msg.to.id, " 🔲┇ Welcome My Dear\n\nTH3HELL V19 \n\n🔲┇For More Information Subscribe To The Channel @CHTH3CZAR \n🔲┇  https://github.com/tomejone99/TH3HELL \n\n🔲┇ Dev :  @TH3HELL\n\n🔲┇ groupmanger : @CHTH3CZAR \n\n🔲┇ Channel :  @CHTH3CZAR ",nil, 'html')
local pvmsg ="🔲┇الاسم :"..name_user.."\n🔲┇الايدي : ["..msg.from.id.."]\n🔲┇المعرف : ["..usernamex.."]\n 📥الرسالة: \n\n"..msg.text

send_msg(321314064, pvmsg, nil, 'md')
...
if string.match(ww, 'احمد')  or  string.match(ww, 'حموشي') or  string.match(ww, 'حموشه') or  string.match(ww, 'حمودي')  or string.match(ww, 'حماده') then
return true
else
return false
end
...
----------------------------------------------
if is_sudo(msg) and w == "جحيم" and not ww then 
return  su[math.random(#su)]  
elseif not is_sudo(msg) and w == "جحيم" and not ww then 
...
elseif w == "جحيم رزله" and ww and is_sudo(msg) then
if msg.reply_id then
...
return "سحك وعدل 😹☝🏿"
-------------- صوتيات
elseif w == "جحيم عفط" and ww and msg.reply_id and is_sudo(msg) then
if msg.reply_id then
sendVoice(msg.to.id, 'data/audio/zeg.ogg', msg.reply_id, '🔲┇اسمع الزيج  اسمع 🔊')
end
elseif w == "جحيم اضحك" and ww and msg.reply_id and is_sudo(msg) then
if msg.reply_id then
 sendVideo(msg.to.id, 'data/video/fun.mp4', nil, caption, msg.reply_id )
end
